...
import { myFilledOrdersLoadedSelector, myFilledOrdersSelector, myOpenOrdersLoadedSelector, myOpenOrdersSelector, filledOrdersSelector, exchangeSelector, accountSelector, orderCancellingSelector } from '../store/selectors'
		...
		return (
			<div className="card bg-dark text-white">
				...
				<div className="card-body">
					<Tabs defaultActiveKey="trades" className="bg-dar text-white">
