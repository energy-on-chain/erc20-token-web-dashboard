...
export const orderBookLoadedSelector = new createSelector(orderBookLoaded, loaded => loaded)

// Create the order book
export const orderBookSelector = new createSelector(
	openOrders,
	(orders) => {
		// Decorate orders
		...
		// Sort buy orders by token prices
		orders = {
			...orders,
		...
		// Sort sell orders by token prices
		orders = {
			...orders,
...
export const myFilledOrdersLoadedSelector = new createSelector(filledOrdersLoaded, loaded => loaded)

export const myFilledOrdersSelector = new createSelector(
	account,
	filledOrders,
	(account, orders) => {
		// Find orders
		orders = orders.filter((o) => o.user.toUpperCase() === account.toUpperCase() || o.userFill.toUpperCase() === account.toUpperCase())
...
export const myOpenOrdersLoadedSelector = new createSelector(orderBookLoaded, loaded => loaded)

export const myOpenOrdersSelector = new createSelector(
	account,
	openOrders,
	(account, orders) => {
		// Find orders
...
export const priceChartLoadedSelector = new createSelector(filledOrdersLoaded, loaded => loaded)

export const priceChartSelector = new createSelector(
	filledOrders,
	(orders) => {
...
const buildGraphData = (orders) => {
	...
	// Calculate price values for O, H, L, C
	const open = group[0]    // open price
